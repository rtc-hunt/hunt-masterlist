...
deriving instance Ord (Puzzle Identity)
...
deriving instance Show (Solution Identity)
deriving instance Eq (Solution Identity)
deriving instance Ord (Solution Identity)
...
deriving instance Show (Note Identity)
...
deriving instance Show (EvalJob Identity)
deriving instance Eq (EvalJob Identity)
deriving instance Ord (EvalJob Identity)
instance ToJSON (EvalJob Identity)
instance FromJSON (EvalJob Identity)
